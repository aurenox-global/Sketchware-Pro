...
public class DesignActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    /**
     * Reloads every project tab (visual editor, events, components) after the
     * in-project AI agent applies actions, so newly created views/events/code
     * appear immediately without leaving the editor.
     */
    public void refreshAfterAiActions() {
        refreshFileSelector();
        if (viewTabAdapter != null) {
            viewTabAdapter.i();
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_preview).setOnClickListener(v -> openLivePreview());
    ...
    private static class BuildTask extends BaseTask implements BuildProgressReceiver {
        ...
        private final List<BuildMetricsStore.StageDuration> stageDurations = new ArrayList<>();
        ...
        private void doInBackground() {
            ...
            try {
                ...
                if (builder.isKmpProjectDetected()) {
                    onProgress(builder.getKmpBuildPipelineStatusMessage(), 3);
                }
        ...
        public void onProgress(String progress, int step) {
            int totalSteps = 20;
            captureStageTransition(progress);
        ...
        private void onPostExecute() {
            ...
            recordMetricsIfNeeded(activity);
        ...
        private void recordMetricsIfNeeded(DesignActivity activity) {
            if (metricsRecorded) {
                return;
            }
            ...
            BuildMetricsStore.recordBuild(
                    activity.getApplicationContext(),
                    "debug_apk",
                    durationMs,
                    buildSucceeded,
                    canceled && !buildSucceeded,
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return new AiLocalEditorFragment();
        }
    }
}
