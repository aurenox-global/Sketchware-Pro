...
public class KotlinCompilerBridge {
    public static void registerCompilationExtension(KotlinCompilationExtension extension) {
        KotlinCompilationPipeline.register(extension);
    }

    public static void unregisterCompilationExtension(KotlinCompilationExtension extension) {
        KotlinCompilationPipeline.unregister(extension);
    }
