...
public class BackupRestoreManager {
    ...
    public void restore() {
                ...
                for (int i = 0; i < files.size(); i++) {
                    ...
                    if (BackupFactory.zipContainsFile(backupFilePath, "local_libs")) {
                        ...
                        new MaterialAlertDialogBuilder(act)
                                ...
                                .setNeutralButton(R.string.common_word_cancel, (d, w) -> doRestore(backupFilePath, false))
                                .show();
        ...
        if (projectsFragment != null) {
            fragmentManager = projectsFragment.getChildFragmentManager();
        } else if (act instanceof AppCompatActivity) {
            fragmentManager = ((AppCompatActivity) act).getSupportFragmentManager();
        }
    ...
    private boolean hasStorageAccess() {
        if (act instanceof BaseAppCompatActivity) {
            return ((BaseAppCompatActivity) act).isStoragePermissionGranted();
        }
        return true;
    }
    ...
    private static class RestoreAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (activity instanceof BaseAppCompatActivity
                    && !((BaseAppCompatActivity) activity).isStoragePermissionGranted()) {
                bm.error = "Storage access is required to restore backups";
                error = true;
                return "";
            }
            ...
            try {
                ...
                bm.error = message != null ? message : e.getClass().getSimpleName();
                Log.e(TAG, "Restore failed for file: " + file, e);
                error = true;
            }
        ...
        private boolean refreshProjectsList() {
            ...
            if (activity instanceof AppCompatActivity) {
                ...
                if (fragment instanceof ProjectsFragment && fragment.isAdded()) {
                    ((ProjectsFragment) fragment).refreshProjectsList();
                    return true;
                }
            }
