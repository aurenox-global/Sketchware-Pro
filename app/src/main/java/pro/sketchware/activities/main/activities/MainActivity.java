...
import pro.sketchware.accessibility.runtime.AccessibilityRuntimeReporter;
...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    private BottomSheetDialogView getBottomSheetDialogView() {
        ...
        bottomSheetDialog.setTitle("Major changes in v7.0.4");
    ...
    public void onResume() {
        super.onResume();
        StartupPerformanceTracker.markMainActivityResumed(getApplicationContext());
        binding.getRoot().post(() ->
            AccessibilityRuntimeReporter.reportViewHierarchy(
