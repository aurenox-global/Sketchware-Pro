...
public class ManageLocalLibraryActivity extends BaseAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("sc_id")) {
            ...
            scId = "system";
            notAssociatedWithProject = true;
        }
        projectUsedLibs = new ArrayList<>();
    ...
    private static class LoadLocalLibrariesTask extends MA {
        private final WeakReference<ManageLocalLibraryActivity> activityRef;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (!notAssociatedWithProject) {
                ...
                binding.materialSwitch.setOnClickListener(v -> {
                    ...
                    int mainPos = adapter.getLocalLibraries().indexOf(library);
                    if (mainPos >= 0) {
